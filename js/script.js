...
const messages = [
    "You're the best sister uyireee ❤️",
    "Happy Birthday Eveline chelloo 🎂",
    "Hope all your wishes come true ✨",
    "Thanks for always being awesome rowdyyy 🌸",
...
setInterval(function() {
    ...
    if(messageBox){
        messageBox.innerHTML = messages[currentMessage];
...
setInterval(function(){
    ...
    boom.style.top = Math.random() * window.innerHeight/2 + "px";
